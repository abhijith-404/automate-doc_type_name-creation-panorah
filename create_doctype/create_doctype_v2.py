...
with open('create_doctype/failed_meta.json', 'r') as f:
    context = json.load(f)
# with open('v1/metajson.json', 'r') as f:
#     context = json.load(f)
...
with ThreadPoolExecutor(max_workers=10) as executor:  # Adjust max_workers as needed
    futures = [executor.submit(send_request, key, value) for key, value in context.items()]
